...
export const SANDBOX_DIR = path.resolve(__dirname, config.sandbox.name);
export const REMOTE_DIR = path.resolve(SANDBOX_DIR, config.git.remote.name);
export const LOCAL_DIR = path.resolve(SANDBOX_DIR, config.git.local.name);
